...
self.addEventListener('fetch', (event) => {
  ...
  if (isHTML) {
    // HTML: tenta a rede primeiro, sempre ignorando cache do navegador,
    // pra nunca travar numa versão antiga do app.
    // Só usa o cache do service worker se estiver offline.
    event.respondWith(
